document.addEventListener("DOMContentLoaded", () => {
  ...
  const searchContainer = document.querySelector(".search-box"); // Targetkan container

  const suggestionBox = document.createElement("div");
  suggestionBox.className = "suggestion-box";
  suggestionBox.style.display = "none"; // Sembunyikan awal
  searchContainer.appendChild(suggestionBox); // Pasang di dalam container

  // Fungsi untuk menampilkan/menyembunyikan box
  searchBox.addEventListener("focus", () => {
      suggestionBox.style.display = "block";
      showHistory();
  });

  // Klik di luar untuk menutup (opsional tapi disarankan)
  ...
  // ... sisanya tetap sama (pages, logic search, dll)

  const pages = {
    "dzikir pagi": "dzikir-pagi.html",
    "dzikir petang": "dzikir-petang.html",
    "dzikir shalat": "dzikir-setelah-shalat.html",
...
suggestionBox.appendChild(errorMsg);
  ...
  function goToPage(url, query) {
    ...
    suggestionBox.style.display = "block"; // Tambahkan baris ini
    suggestionBox.innerHTML = "";
    // ... sisa kode showHistory Anda
